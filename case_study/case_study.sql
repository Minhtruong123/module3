...
insert into bo_phan (ma_bo_phan, ten_bo_phan) values (1, 'Sale_Marketing');
...
insert into bo_phan (ma_bo_phan, ten_bo_phan) values (4, 'Quản lí');
...
insert into dich_vu(ma_dich_vu, ten_dich_vu, dien_tich, chi_phi_thue, so_nguoi_toi_da, tieu_chuan_phong, mo_ta_tien_nghi_khac, dien_tich_ho_boi, so_tang, dich_vu_di_kem, ma_kieu_thue, ma_loai_dich_vu) values (1, 'Villa Beach Front', 25000, '1000000', 10, 'vip', 'Có hồ bơi', 500, 4, null, 3,1);
insert into dich_vu(ma_dich_vu, ten_dich_vu, dien_tich, chi_phi_thue, so_nguoi_toi_da, tieu_chuan_phong, mo_ta_tien_nghi_khac, dien_tich_ho_boi, so_tang, dich_vu_di_kem, ma_kieu_thue, ma_loai_dich_vu) values (2, 'House Princess 01', 14000, '5000000', 7, 'vip', 'Có thêm bếp nướng', null, 3, null, 2,2);
insert into dich_vu(ma_dich_vu, ten_dich_vu, dien_tich, chi_phi_thue, so_nguoi_toi_da, tieu_chuan_phong, mo_ta_tien_nghi_khac, dien_tich_ho_boi, so_tang, dich_vu_di_kem, ma_kieu_thue, ma_loai_dich_vu) values (3, 'Room Twin 01', 5000, '1000000', 2, 'normal', 'Có tivi', null, null, '1 Xe máy, 1 Xe đạp', 4,3);
insert into dich_vu(ma_dich_vu, ten_dich_vu, dien_tich, chi_phi_thue, so_nguoi_toi_da, tieu_chuan_phong, mo_ta_tien_nghi_khac, dien_tich_ho_boi, so_tang, dich_vu_di_kem, ma_kieu_thue, ma_loai_dich_vu) values (4, 'Villa No Beach Front', 22000, '9000000', 8, 'normal', 'Có hồ bơi', 300, 3, null, 3,1);
insert into dich_vu(ma_dich_vu, ten_dich_vu, dien_tich, chi_phi_thue, so_nguoi_toi_da, tieu_chuan_phong, mo_ta_tien_nghi_khac, dien_tich_ho_boi, so_tang, dich_vu_di_kem, ma_kieu_thue, ma_loai_dich_vu) values (5, 'House Princess 02', 10000, '4000000', 5, 'normal', 'Có thêm bếp nướng', null, 2, null, 3,2);
insert into dich_vu(ma_dich_vu, ten_dich_vu, dien_tich, chi_phi_thue, so_nguoi_toi_da, tieu_chuan_phong, mo_ta_tien_nghi_khac, dien_tich_ho_boi, so_tang, dich_vu_di_kem, ma_kieu_thue, ma_loai_dich_vu) values (6, 'Room Twin 02', 3000, '900000', 2, 'normal', 'Có tivi',null, null, '1 Xe máy', 4,3);
...
insert into hop_dong(ma_hop_dong, ngay_lam_hop_dong, ngay_ket_thuc, tien_dat_coc, ma_nhan_vien, ma_khach_hang, ma_dich_vu) values (8, '2021-06-17', '2021-06-18', 150000, 3, 1, 3);
insert into hop_dong(ma_hop_dong, ngay_lam_hop_dong, ngay_ket_thuc, tien_dat_coc, ma_nhan_vien, ma_khach_hang, ma_dich_vu) values (9, '2020-12-08', '2020-12-08', 0, 3, 4, 1);
...
insert into hop_dong_chi_tiet(ma_hop_dong_chi_tiet, so_luong, ma_hop_dong, ma_dich_vu_di_kem) values (3, 14, 2, 6);
