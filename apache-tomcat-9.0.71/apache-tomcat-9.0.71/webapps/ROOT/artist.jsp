...
<div class="row">
    <div class="col-12">
        ...
        <%--gallery--%>
        <div class="row d-flex align-items-center bg-secondary me-0" style="height: 700px">
            <div class="col-6">
                <div class="row">
        ...
        <%--link to choice--%>
        <div class="row d-flex align-items-center" style="background-color: #eae6e6; height: 130px">
            <div class="col-12">
